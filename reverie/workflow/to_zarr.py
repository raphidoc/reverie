...
if __name__ == "__main__":
    ...
    # )
    # test.to_zarr(
    #     "/D/Data/TEST/TEST_WISE/MC-51A/EXAMPLE_190818_MC-51A-WI-2x1x1_v02-L1C.zarr"
    # )

    l1 = wise.read_pix.Pix(
        image_dir="/D/Data/TEST/TEST_WISE/MC-12A/",
        image_name="190820_MC-12A-WI-1x1x1_v02",
    )

    l1.to_zarr("/D/Data/TEST/TEST_WISE/MC-12A/190820_MC-12A-WI-1x1x1_v02-L1C.zarr")
